...
def main() -> None:
    ...
    # Three deterministic executions of a realistic customer-follow-up workflow.
    # Each ends with a strong Send completion so repeated-task mining has a clear
    # boundary and the first-time demo dashboard is intentionally non-empty.
    for i in range(3):
