(() => {
  ...
  window.openGatewaySetup = function() {
    ...
    document.querySelector('#gwConnectBtn').onclick=async function(){
      ...
      } catch(err) { btn.disabled=false; btn.textContent='Connect and start sharing'; alert(err.message); }
    };
  };
