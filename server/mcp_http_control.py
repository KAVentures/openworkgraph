...
def status() -> dict[str, Any]:
    ...
    with _LOCK:
        ...
        return {
            "running": _alive(),
            "endpoint": _ENDPOINT if _alive() else None,
            "transport": "streamable-http" if _alive() else None,
        }
        ...
        for port in _candidate_ports():
            ...
            if process.poll() is None:
                ...
                try:
                    ...
                    process.kill()
        _write_state(None)
        return {"running": False, "endpoint": None, "transport": None, "error": "Could not start local HTTP MCP"}
